import { resolveLessVars, findLessVarsInText, findLessVars } from '@/strategies/less-vars';
...
describe('less-vars', () => {
  ...
  describe('findLessVars', () => {
    ...
    it('should return accurate position for @variable usage', async () => {
      ...
      const result = await findLessVars(prefix + text);
      expect(result).toHaveLength(1);
    ...
    it('should return empty array for no Less variables', async () => {
